...
export default function Projects() {
  ...
  const myprojects = [
    ...
    {titel : "Books website ", category:"reactJs & TelweaindCss", prograf:"This website was built using React.js, a book API, and Tailwind CSS to showcase our extensive collection of books and provide user registration and login functionality." , ImagePath : BokesReact, url:"https://bookeswebsite-javascript.vercel.app/"},
